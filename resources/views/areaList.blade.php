...
<div class="container">
   <div class="row">
     <div class="col-md-7">
       <h1 class="text-white font-weight-bold">Area List</h1>
       <div class="custom-breadcrumbs">
         <a href="#">Home</a> <span class="mx-2 slash">/</span>
         <a href="#">Area</a> <span class="mx-2 slash">/</span>
         <span class="text-white"><strong>Area List</strong></span>
       </div>
     </div>
   </div>
 </div>
...
<tbody>
   <tr>
    ...
    <td scope="col">modifiedDate</td>
    <td scope="col">modifiedBy</td>
    <td scope="col">
         <a href="areaCreate" class="btn btn-warning">Create</a>
      </td>
      <td>
         <a href="areaUpdate" class="btn btn-info">Update</a>
      </td>
   </tr>
</tbody>
</table>
